...
exports.updateModel = (0, middlewares_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedModel = yield config_1.prisma.model.update({
        where: { id },
        data: Object.assign({ name: validData.name, age: validData.age, email: validData.email, phone: validData.phone, whatsapp: validData.whatsapp, address: validData.address, isActive: validData.isActive, service: validData.service, height: validData.height, weight: validData.weight, price: validData.price, description: validData.description }, (uploadedImages.length > 0 && {
            image: {
